...
function PageHero({ title, subtitle }: PageHeroProps) {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-950 via-slate-900 to-black pt-20">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <p className="fade-in-up-delay-1 text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
          {subtitle}
        </p>
      </div>
    </section>
